...
_j24:
# addr = 0x24
ori x1, x0, 0x3				# (3) x1 = 0x00000024
jalr x2, 4(x3)				# (3) jump to 0x1c and set x2 = 2c

ori x1, x0, 0x6				# (6) x1 = 0x0000002c
ori x1, x0, 0x7				# (7) x1 = 0x00000030
j		_j48				# (6) jump to 0x80

_j38:
# addr =  0x38
ori x1, x0, 0x5				# (5) x1 = 0x00000038
...
_j48:
# addr = 0x48
ori x1, x0, 0x8				# (8) x1 = 0x00000048
ori x1, x0, 0x000			# (8) x1 = 0x00000000
